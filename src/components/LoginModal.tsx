...
export default function LoginModal() {
  ...
  return (
    <ResponsiveModal
      open={loginModalOpen}
      onOpenChange={(o) => !o && closeLogin()}
      title="Sign in to continue"
      description="We use your Google account to send the application email from your own address, and to save your resume and application history."
      desktopClassName="max-w-[420px]"
    >
